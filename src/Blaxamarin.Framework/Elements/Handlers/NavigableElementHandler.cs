...
namespace Blaxamarin.Framework.Elements.Handlers
{
    ...
    {
        public NavigableElementHandler(EmblazonRenderer<IFormsControlHandler> renderer, XF.NavigableElement navigableElementControl) : base(renderer, navigableElementControl)
        {
