...
{
    public partial class SkiaGLNativeControlEventsDemo
    {
        protected override void OnAfterRender(bool firstRender)
        {
            ...
            if(firstRender)
            {
                (CanvasView.NativeControl as SK.SKGLView).PaintSurface += SkiaSharpGLPlayground_PaintSurface;
                (CanvasView2.NativeControl as SK.SKGLView).PaintSurface += SkiaSharpGLPlayground_PaintSurface2;
            }
        }

        private void SkiaSharpGLPlayground_PaintSurface2(object sender, SK.SKPaintGLSurfaceEventArgs e)
        {
            PaintSurface(e);
        }

        private void SkiaSharpGLPlayground_PaintSurface(object sender, SK.SKPaintGLSurfaceEventArgs e)
        {
            PaintSurface2(e);
        }

        public SKGLView CanvasView { get; set; }
        public SKGLView CanvasView2 { get; set; }
        ...
        private void PaintSurface2(SK.SKPaintGLSurfaceEventArgs e)
        {
        ...
        private void PaintSurface(SK.SKPaintGLSurfaceEventArgs e)
        {
            var canvas = e.Surface.Canvas;
